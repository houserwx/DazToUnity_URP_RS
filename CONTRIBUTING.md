...
1. Make an [Issue](https://github.com/recursedstudios/daztounitybridge/issues/new)
...
```json
    {
        "dependencies": {
            "com.recursedstudios.daztounitybridge": "https://github.com/YOUR_USER/daztounitybridge.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at recursedstudios@gmail.com.
